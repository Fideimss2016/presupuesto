<?php
	...
	if (isset($_REQUEST['conse_act'])){$_SESSION['conse_act'] = $_REQUEST['conse_act'];}
	if (isset($_REQUEST['conse_partida'])){$_SESSION['conse_partida'] = $_REQUEST['conse_partida'];}
	if (isset($_REQUEST['conse_categoria'])){$_SESSION['conse_categoria'] = $_REQUEST['conse_categoria'];}
	...
	if ($conse_categoria == 4)
	{
		echo "  <span class=\"spgreen\"><br>El limite maximo de honorarios es de 10,955.09</span></td>";
	}
	else if ($conse_categoria == 5 || $conse_categoria == 6)
	{
		echo " <span class=\"spgreen\"><br>El limite maximo de honorarios es de 8,764.80</span></td>";
	}
	echo "		</tr>";
...
//	}
	...
	echo "		</td>";
	echo "		<td bgcolor=\"$celda\">";
	echo "		<span class=\"spblue\"><input type=\"text\" id=\"popupDatepicker\" name=\"inicio\" value=\"01-06-2016\" required></span>";
	echo "		</td>";
	...
	echo "		</td>";
	echo "		<td bgcolor=\"$celda\" colspan=\"1\">";
	echo "		<span class=\"spblue\"><input type=\"text\" id=\"popupDatepickers\" name=\"termino\" value=\"31-08-2016\" required></span>";
	echo "		</td>";
...
*/
	...
	if ($conse_categoria == 4)
	{
		echo "		<input type=\"number\" name=\"subtotals\" id=\"subtotals\" size=\"20\" min=\"1\" max=\"10955.09\" required>";
	}
	else if($conse_categoria == 5 || $conse_categoria == 6)
	{
		echo "		<input type=\"number\" name=\"subtotals\" id=\"subtotals\" size=\"20\" min=\"1\" max=\"8764.80\" required>";	
	}
	echo "		</td>";
	}
...
//	echo "<input type=\"button\" value=\"Atr&aacute;s\" onclick=\"history.go(-1)\" /> | <input type=\"submit\" value=\"Guardar registro\" />";
	echo "<input type=\"button\" value=\"Atr&aacute;s\" onclick=\"document.location ='personal.php'\" /> | <input type=\"submit\" value=\"Guardar registro\" />";

<?php
	...
	$claveA=$_REQUEST['clave'];
	if(isset($_REQUEST['clave']))
	{
		echo $_REQUEST['clave'];
	}
	if(isset($_REQUEST['id_conse_egresos']))
	{
		echo $_REQUEST['id_conse_egresos'];
	}
...
/*
	...
	*/
	...
	echo"
				...
				<option value=\"0\">seleccione partida presupuestal</option>
				";
	...
	echo "		<select name=\"conse_act\">";
				$result=mysql_query("select conse_act, clave_act, actividad from cat_actividades_i where activo = 1 order by conse_act", $connect);
	...
	echo "		<tr><td colspan=\"4\">&nbsp;</td></tr>";
		...
		{
		echo "<tr><td  colspan=\"4\" align=\"center\"><span class=\"spred\">El Plan Rector 2017 correspondiente al area de Egresos ya se ha enviado a revisi&oacute;n ya no es posible realizar capturas!!!</span></td></tr>";
		}

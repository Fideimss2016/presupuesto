...
echo "<tr><th scope=\"col\" bgcolor=\"$c1\" colspan=\"3\" align=\"left\"><span class=\"spgrey\">&nbsp;<b>$desc_del</b></th></tr>";
	...
	echo "<tr>
		...
		if($status==0)
			{
			echo "    <td bgcolor=\"$celda\" align=\"center\"><span class=$color><a href=\"vcapturasox.php?clave=$clave\" title=\"capturando registros\" target=\"_blank\"><img src=\"capturando.png\" width=\"20\" height=\"20\" /></a></span></td>";
			}
		else if($status==1)
			{
			echo "    <td bgcolor=\"$celda\" align=\"center\"><span class=$color><a href=\"vcapturasox.php?clave=$clave\" title=\"programa en revision por el jefe de oficina\" target=\"_blank\"><img src=\"revision.png\" width=\"20\" height=\"20\" /></a></span></td>";
			}
		else if($status==2)
			{
			echo "    <td bgcolor=\"$celda\" align=\"center\"><span class=$color><a href=\"vcapturasox.php?clave=$clave\" title=\"en espera de autorizacion de fideimss\" target=\"_blank\"><img src=\"fidecheck.png\" width=\"30\" height=\"30\" /></a></span></td>";
			}

		else if($status==3)
			{
			echo "    <td bgcolor=\"$celda\" align=\"center\"><span class=$color><a href=\"vcapturasox.php?clave=$clave\" title=\"programa aprobado\" target=\"_blank\"><img src=\"aprobado.png\" width=\"20\" height=\"20\" /></a></span></td>";
			}

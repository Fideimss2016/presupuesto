...
//	echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"contenido.css\">";
	...
	if ($_GET[buscar]=="hijos")
	{
		...
		if($_GET["tipo_proyecto_id"]=="10")//Bienes muebles 0501
		{
			echo "	<div class=\"form-group\" id=\"pidhijo\">
						<label class=\"col-md-4 control-label\" for=\"tipo_gasto_id\" style=\"text-align: right\">Tipo de bien</label>
						<div class=\"col-md-8\">
							<select name='tipo_gasto_id' id='tipo_gasto_id' class='form-control' required>";
	...
	if ($_GET[buscar]=="nietos")
	{
		...
		{
			echo "	<div class=\"form-group\" id=\"pidnieto\">
						<label class=\"col-md-4 control-label\" for=\"tipo_equipo_id\" style=\"text-align: right\">Servicio requerido</label>
						<div class=\"col-md-8\">
							<select name='tipo_equipo_id' id='tipo_equipo_id' class='form-control' required>";

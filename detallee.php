...
*/
	...
	$result=mysql_query("select e.id_conse_egresos,e.clave_act,e.clave_par,e.cantidad,e.unidad,e.total_gasto,ci.actividad,cp.desc_par,e.status
		from egresos e, cat_actividades_i ci, cat_partidas_e cp where clave=$clave and ci.clave_act=e.clave_act and cp.clave_par=e.clave_par and e.id_par in ('02','03', '04') order by clave_par", $connect);
	$totalregistros=mysql_num_rows($result);
	$valcolor = 0;
	while($row=mysql_fetch_array($result))
	{
	...
	echo "<tr><td><span class=\"spwhite\"><b>&nbsp;INVERSION FISICA / INVERSION PUBLICA</b></span></td></tr>";
	...
	$resulto=mysql_query("select o.id_conse_obra,o.clave_act,o.clave_par,o.cantidad,o.unidad,o.monto,ci.actividad,cp.desc_par,o.status
		from obras o, cat_actividades_i ci, cat_partidas_e cp where clave='$clave' and ci.clave_act=o.clave_act and cp.clave_par in ('0203','0311', '0501', '0601', '0602', '0603') and cp.clave_par=o.clave_par order by clave_par", $connect);

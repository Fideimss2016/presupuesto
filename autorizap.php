<?php
	...
	cc.honorarios,cc.iva, cc.subtotal,cc.retisr,cc.retiva,cc.neto,p.meses from personal p, cat_partidas_e cpe, cat_actividades_i cai, cat_categoria cc where clave='$clave' and cpe.clave_par=p.clave_par 
	and cai.clave_act=p.clave_act and cc.conse_categoria=p.conse_categoria order by conse_categoria", $connect);
	$totalregistros = mysql_num_rows($result);
	$valcolor = 0;
	while($row = mysql_fetch_array($result))
	{
		...
		$result3 = mysql_query("select status from metas m where m.clave='$clave' and m.id_emp=$id_emp", $connect);
		...
		{
			$results = mysql_query("select status from personal p where clave='$clave' and p.id_emp=$id_emp", $connect);
	...
	if (isset($vobo)) 
	{
		...
		$sqlUpdate = mysql_query("UPDATE personal SET status=3 where clave='$clave'", $connect) or die(mysql_error());
		if($sqlUpdate)
		{
			echo "Su Plan Rector 2017 correspondiente al Area de Personal ha sido aprobado!!!";
			...
			$cuerpo 		= "		<html>
										...
										<body>
											...
											<p>
												<b>C.P. Leticia Giles Olvera</b><br><br> Le informo que que he dado vobo a su Plan Rector 2017 correspoendiente al &Aacute;rea de Personal de $desc_uops.<br><br><b>C.P. José Antonio Olivarez Godínez</b>
											</p>
										</body>
									</html>";
			...
			$headers .= "Cc: fideimss@fideimss.org.mx, jantonio.olivarez@fideimss.org.mx, martha.benitez@fideimss.org.mx\r\n";
	...
	if($result != 0)
	{
		...
		{
			echo "			<tr>
								<td align=\"center\">El Plan Rector 2017 sigue en status de captura!!!</td>
							</tr>";
			echo "			<tr>
								<td align=\"center\"><a href=\"imprime_personal.php\">Imprimir</a></td>
							</tr>";
		}
		else if($status == 1 && $numerosc != 0)
		{
			if($tipo_usuario == 'ADM' || $tipo_usuario == 'CON')
			{
				...
				echo "		<tr>
								<td align=\"center\">
									<input name=\"vobo\" type=\"checkbox\" value=\"si\"> Autorizar y Enviar a Fideimss para Autorizacion | <a href=\"imprime_personal.php\">Imprimir</a> | <a href=\"vcapturaspl.php?clave=$clave\">Liberar Sistema para realizar cambios</a>
								</td>
							</tr>";
			...
			{
				echo "		<tr>
								<td align=\"center\">El Plan Rector 2017 este en proceso de revision por el jefe de oficina!!!</td>
							</tr>";
				echo "		<tr>
								<td align=\"center\"><a href=\"imprime_personal.php\">Imprimir</a></td>
							</tr>";
		...
		else if($status == 2 || $status == 5 && $numerosc != 0)
		{
			if($tipo_usuario == 'JD4')
			{
				echo "		<form name='form1' action='autorizap.php' method='POST'>";
				echo "			<tr>
									<td align=\"center\">
										<input name=\"vobo\" type=\"checkbox\" value=\"si\"> Autorizar Programa | <a href=\"imprime_personal.php\">Imprimir</a> | <a href=\"vcapturaspl.php?clave=$clave\">Liberar Sistema para realizar cambios</a>
									</td>
								</tr>";
				echo "			<input type=\"hidden\" name=\"clave\" value=\"$clave\">";
				echo "			<tr>
			...
			{
				echo "		<tr>
								<td align=\"center\">El Plan Rector 2017 ha sido autorizado por el Jefe de Oficina y ha sido enviado al personal de Fideimss para autorizacion!!!</td>
							</tr>";
				echo "		<tr>
								<td align=\"center\"><a href=\"imprime_personal.php\">Imprimir</a></td>
							</tr>";

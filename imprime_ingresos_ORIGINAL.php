...
//echo "valores: $jefe_e $jefe_i $jefe_o $jefe_p";
...
$pdf->SetXY(5,$y);
//$pdf->MultiCell(285,4,"DELEGACION: $jefe_e $jefe_i $jefe_o $jefe_p" . $desc_del,0,'L');
...
$pdf->SetFont('Arial','',4);
		...
		$pdf->SetXY(15,$y);
		$pdf->MultiCell(37,4,$actividad,1,'L',$val);
		$pdf->SetXY(52,$y);
...
$pdf->SetDrawColor(51,51,51);
		...
		$y=$y+4;
			...
			$pdf->MultiCell(37,4,$actividad,1,'L',$val);
			$pdf->SetXY(52,$y);
			$pdf->MultiCell(40,4,$desc_tipo_pago,1,'L',$val);
			$pdf->SetXY(92,$y);

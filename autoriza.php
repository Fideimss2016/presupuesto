<?php
	...
	$sqlUpdate = mysql_query("UPDATE ingresos SET status=3 where clave='$clave'", $connect) or die(mysql_error());
	if($sqlUpdate)
	{
		echo "El Plan Rector 2017 correspondiente al &Aacute;rea de Ingresos ha sido aprobado!!!";
		...
		$cuerpo = "		<html>
							...
							<body>
								...
								<p>
									<b>$jefe</b><br><br> Le informo que he dado vobo a su Plan Rector 2017 correspoendiente al &Aacute;rea de Ingresos de $desc_uops, ya pueden imprimir el programa, recolectar firmas y enviarlo a este fideicomiso, para analizar la viabilidad de su proyecto.<br><br><b>C.P. Reynaldo Arias Villavicencio</b>
								</p>
							</body>
						</html>";
		...
		$headers .= "Cc: fideimss@fideimss.org.mx, $email_1, reynaldo.arias@fideimss.org.mx\r\n";

			    ...
			    <form role="form" action="guardar.php" method="POST" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="form-group" id="pidactividad">
                            ...
                            <div class="col-md-3">
                                <input id="TotalCursos" name="TotalCursos" class="form-control input-md" type="text" style="text-align: right" required>
                            </div>
                            <div class="col-md-12">&nbsp</div>
                            ...
                            <div class="col-md-12">&nbsp</div>
                                ...
                                <div class="col-md-3">
                                    <input id="TotalIngresos" name="TotalIngresos" class="form-control input-md" type="text">
                                </div>
                                <div class="col-md-3">
                                    &nbsp
                                </div>

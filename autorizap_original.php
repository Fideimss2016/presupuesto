...
<p>
<b>C.P. Leticia Giles Olvera</b><br><br> Le informo que que he dado vobo a su Plan Rector 2017 correspoendiente al &Aacute;rea de Personal de $desc_uops.<br><br><b>C.P. Humberto Jose Ayanegui Limon</b>
</p>
</body>
</html>
";
...
if($result!=0)
{
	...
	else if($status==1 && $numerosc!=0)
	{
		...
		echo "<tr><td align=\"center\"><input name=\"vobo\" type=\"checkbox\" value=\"si\"> Autorizar y Enviar a Fideimss para Autorizacion | <a href=\"imprime_personal.php\">Imprimir</a> | <a href=\"vcapturaspl.php?clave=$clave\">Liberar Sistema para realizar cambios</a></td></tr>";
	...
	else if($status==2 || $status==5 && $numerosc!=0)
	{
		...
		echo "<tr><td align=\"center\"><input name=\"vobo\" type=\"checkbox\" value=\"si\"> Autorizar Programa | <a href=\"imprime_personal.php\">Imprimir</a> | <a href=\"vcapturaspl.php?clave=$clave\">Liberar Sistema para realizar cambios</a></td></tr>";
		echo "<input type=\"hidden\" name=\"clave\" value=\"$clave\">";
		echo "<tr><td align=\"center\"><input type=\"submit\" value=\"continuar\" /></td></tr>";
		echo "</form>";
		}

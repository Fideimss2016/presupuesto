...
$_SESSION['sesiones']=$_REQUEST['sesiones'];
$_SESSION['horasxsesion']=$_REQUEST['horasxsesion'];
...
$horasxsesion=$_SESSION["horasxsesion"];
...
echo "		<span class=\"spgreen\">$sesiones</span>";
echo "		</td>";
...
echo "		<span class=\"spblue\">$horasxsesion</span>";
echo "		</td>";
echo "		</tr>";

		$sqlUpdate = mysql_query("UPDATE plan SET tema='$tema',objpar='$objpar',tecnica='$tecnica',material='$material',
								 docente='$docente',usuario='$usuario',sesiones=$sesiones,horasxsesion=$horasxsesion
							  	 WHERE clave='$clave' and id_emp=$id_emp and conse_plan=$conse_plan", $connect) or die(mysql_error());

						if($sqlUpdate){echo "<span class=\"spblue\">El plan se ha editado correctamente!!!</span>";}
						else{echo "<span class=\"spred\">Error en el registro del plan!!!</span>";}

						echo "		<br>";
								 echo "<a href=\"plan.php?id_emp=$id_emp&&clave=$clave\">Regresar</a>";

...
//$sqlEliminar = mysql_query("UPDATE ingresos SET activo = 0 WHERE id_conse_ing=$id_conse_ing and clave='$clave'", $connect) or die(mysql_error());
...
/*****/
			...
			else if($tip==1 || $tip==4 || $tip==10 || $tip==42  || $tip==54 || $tip==57 || $tip==58 || $tip==61 || $tip==67 || $tip==17 || $tip==15 || $tip==19 || $tip==21 || $tip==23 || $tip==25 || $tip==27 || $tip==29 || $tip==31 || $tip==33 || $tip==35 || $tip==37 || $tip==39  || $tip==41)
			{
				$result=mysql_query("select id_tipo_pago, desc_tipo_pago from cat_tipo_pago_i where id_tipo_pago in (1,2,3) order by id_tipo_pago", $connect);
			}
			...
			else if($tip==2 || $tip==5 || $tip==8 || $tip==9 || $tip==11 || $tip==12 || $tip==43 || $tip==45 || $tip==46 || $tip==52 || $tip==55 || $tip==56 || $tip==59 || $tip==60 || $tip==62 || $tip==66 || $tip==68 || $tip == 67 || $tip == 61 || $tip == 62 || $tip == 10 || $tip == 11 || $tip == 1 || $tip == 2 || $tip == 42 || $tip == 43 || $tip == 4 || $tip == 5 || $tip == 58 || $tip == 59 || $tip == 54 || $tip == 57 || $tip == 31 || $tip == 31 || $tip == 33 || $tip == 35 || $tip ==37 || $tip == 39 || $tip == 41 || $tip == 15 || $tip == 17 || $tip == 19 || $tip == 21 || $tip == 23 || $tip == 25 || $tip == 27 || $tip == 29)
			{

...
/*
	if ($_POST["dh1"] || $_POST["ndh1"]){$_SESSION['dh1']=$_REQUEST['dh1']; $_SESSION['ndh1']=$_REQUEST['ndh1']; $dh1=$_SESSION["dh1"]; $ndh1=$_SESSION["ndh1"];} else{$_SESSION['dh1']=0; $_SESSION['ndh1']=0;}
	if ($_POST["dh2"] || $_POST["ndh2"]){$_SESSION['dh2']=$_REQUEST['dh2']; $_SESSION['ndh2']=$_REQUEST['ndh2']; $dh2=$_SESSION["dh2"]; $ndh2=$_SESSION["ndh2"];} else{$_SESSION['dh2']=0; $_SESSION['ndh2']=0;}
	if ($_POST["dh3"] || $_POST["ndh3"]){$_SESSION['dh3']=$_REQUEST['dh3']; $_SESSION['ndh3']=$_REQUEST['ndh3']; $dh3=$_SESSION["dh3"]; $ndh3=$_SESSION["ndh3"];} else{$_SESSION['dh3']=0; $_SESSION['ndh3']=0;}
	if ($_POST["dh4"] || $_POST["ndh4"]){$_SESSION['dh4']=$_REQUEST['dh4']; $_SESSION['ndh4']=$_REQUEST['ndh4']; $dh4=$_SESSION["dh4"]; $ndh4=$_SESSION["ndh4"];} else{$_SESSION['dh4']=0; $_SESSION['ndh4']=0;}
	if ($_POST["dh5"] || $_POST["ndh5"]){$_SESSION['dh5']=$_REQUEST['dh5']; $_SESSION['ndh5']=$_REQUEST['ndh5']; $dh5=$_SESSION["dh5"]; $ndh5=$_SESSION["ndh5"];} else{$_SESSION['dh5']=0; $_SESSION['ndh5']=0;}
	if ($_POST["dh6"] || $_POST["ndh6"]){$_SESSION['dh6']=$_REQUEST['dh6']; $_SESSION['ndh6']=$_REQUEST['ndh6']; $dh6=$_SESSION["dh6"]; $ndh6=$_SESSION["ndh6"];} else{$_SESSION['dh6']=0; $_SESSION['ndh6']=0;}
	if ($_POST["dh7"] || $_POST["ndh7"]){$_SESSION['dh7']=$_REQUEST['dh7']; $_SESSION['ndh7']=$_REQUEST['ndh7']; $dh7=$_SESSION["dh7"]; $ndh7=$_SESSION["ndh7"];} else{$_SESSION['dh7']=0; $_SESSION['ndh7']=0;}
	if ($_POST["dh8"] || $_POST["ndh8"]){$_SESSION['dh8']=$_REQUEST['dh8']; $_SESSION['ndh8']=$_REQUEST['ndh8']; $dh8=$_SESSION["dh8"]; $ndh8=$_SESSION["ndh8"];} else{$_SESSION['dh8']=0; $_SESSION['ndh8']=0;}
	if ($_POST["dh9"] || $_POST["ndh9"]){$_SESSION['dh9']=$_REQUEST['dh9']; $_SESSION['ndh9']=$_REQUEST['ndh9']; $dh9=$_SESSION["dh9"]; $ndh9=$_SESSION["ndh9"];} else{$_SESSION['dh9']=0; $_SESSION['ndh9']=0;}
	if ($_POST["dh10"] || $_POST["ndh10"]){$_SESSION['dh10']=$_REQUEST['dh10']; $_SESSION['ndh10']=$_REQUEST['ndh10']; $dh10=$_SESSION["dh10"]; $ndh10=$_SESSION["ndh10"];} else{$_SESSION['dh10']=0; $_SESSION['ndh10']=0;}
	if ($_POST["dh11"] || $_POST["ndh11"]){$_SESSION['dh11']=$_REQUEST['dh11']; $_SESSION['ndh11']=$_REQUEST['ndh11']; $dh11=$_SESSION["dh11"]; $ndh11=$_SESSION["ndh11"];} else{$_SESSION['dh11']=0; $_SESSION['ndh11']=0;}
	if ($_POST["dh12"] || $_POST["ndh12"]){$_SESSION['dh12']=$_REQUEST['dh12']; $_SESSION['ndh12']=$_REQUEST['ndh12']; $dh12=$_SESSION["dh12"]; $ndh12=$_SESSION["ndh12"];} else{$_SESSION['dh12']=0; $_SESSION['ndh12']=0;}
*/
...
echo "		<form action=\"inserta_ingresos.php\" method=\"post\" enctype=\"multipart/form-data\" target=\"_self\" name=\"a\">";

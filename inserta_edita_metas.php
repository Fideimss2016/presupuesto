...
if ($_POST["h1"]){$_SESSION['h1']=$_REQUEST['h1']; $h1=$_SESSION["h1"];$_SESSION['dh1']=$_REQUEST['dh1']; $dh1=$_SESSION["dh1"];$_SESSION['ndh1']=$_REQUEST['ndh1']; $ndh1=$_SESSION["ndh1"];}
else{$_SESSION['h1']=0;$_SESSION['dh1']=0;$_SESSION['ndh1']=0;}
if ($_POST["h2"]){$_SESSION['h2']=$_REQUEST['h2']; $h2=$_SESSION["h2"];$_SESSION['dh2']=$_REQUEST['dh2']; $dh2=$_SESSION["dh2"];$_SESSION['ndh2']=$_REQUEST['ndh2']; $ndh2=$_SESSION["ndh2"];}
else{$_SESSION['h2']=0;$_SESSION['dh2']=0;$_SESSION['ndh2']=0;}
if ($_POST["h3"]){$_SESSION['h3']=$_REQUEST['h3']; $h3=$_SESSION["h3"];$_SESSION['dh3']=$_REQUEST['dh3']; $dh3=$_SESSION["dh3"];$_SESSION['ndh3']=$_REQUEST['ndh3']; $ndh3=$_SESSION["ndh3"];}
else{$_SESSION['h3']=0;$_SESSION['dh3']=0;$_SESSION['ndh3']=0;}
if ($_POST["h4"]){$_SESSION['h4']=$_REQUEST['h4']; $h4=$_SESSION["h4"];$_SESSION['dh4']=$_REQUEST['dh4']; $dh4=$_SESSION["dh4"];$_SESSION['ndh4']=$_REQUEST['ndh4']; $ndh4=$_SESSION["ndh4"];}
else{$_SESSION['h4']=0;$_SESSION['dh4']=0;$_SESSION['ndh4']=0;}
if ($_POST["h5"]){$_SESSION['h5']=$_REQUEST['h5']; $h5=$_SESSION["h5"];$_SESSION['dh5']=$_REQUEST['dh5']; $dh5=$_SESSION["dh5"];$_SESSION['ndh5']=$_REQUEST['ndh5']; $ndh5=$_SESSION["ndh5"];}
else{$_SESSION['h5']=0;$_SESSION['dh5']=0;$_SESSION['ndh5']=0;}
if ($_POST["h6"]){$_SESSION['h6']=$_REQUEST['h6']; $h6=$_SESSION["h6"];$_SESSION['dh6']=$_REQUEST['dh6']; $dh6=$_SESSION["dh6"];$_SESSION['ndh6']=$_REQUEST['ndh6']; $ndh6=$_SESSION["ndh6"];}
else{$_SESSION['h6']=0;$_SESSION['dh6']=0;$_SESSION['ndh6']=0;}
if ($_POST["h7"]){$_SESSION['h7']=$_REQUEST['h7']; $h7=$_SESSION["h7"];$_SESSION['dh7']=$_REQUEST['dh7']; $dh7=$_SESSION["dh7"];$_SESSION['ndh7']=$_REQUEST['ndh7']; $ndh7=$_SESSION["ndh7"];}
else{$_SESSION['h7']=0;$_SESSION['dh7']=0;$_SESSION['ndh7']=0;}
if ($_POST["h8"]){$_SESSION['h8']=$_REQUEST['h8']; $h8=$_SESSION["h8"];$_SESSION['dh8']=$_REQUEST['dh8']; $dh8=$_SESSION["dh8"];$_SESSION['ndh8']=$_REQUEST['ndh8']; $ndh8=$_SESSION["ndh8"];}
else{$_SESSION['h8']=0;$_SESSION['dh8']=0;$_SESSION['ndh8']=0;}
if ($_POST["h9"]){$_SESSION['h9']=$_REQUEST['h9']; $h9=$_SESSION["h9"];$_SESSION['dh9']=$_REQUEST['dh9']; $dh9=$_SESSION["dh9"];$_SESSION['ndh9']=$_REQUEST['ndh9']; $ndh9=$_SESSION["ndh9"];}
else{$_SESSION['h9']=0;$_SESSION['dh9']=0;$_SESSION['ndh9']=0;}
if ($_POST["h10"]){$_SESSION['h10']=$_REQUEST['h10']; $h10=$_SESSION["h10"];$_SESSION['dh10']=$_REQUEST['dh10']; $dh10=$_SESSION["dh10"];$_SESSION['ndh10']=$_REQUEST['ndh10']; $ndh10=$_SESSION["ndh10"];}
else{$_SESSION['h10']=0;$_SESSION['dh10']=0;$_SESSION['ndh10']=0;}
if ($_POST["h11"]){$_SESSION['h11']=$_REQUEST['h11']; $h11=$_SESSION["h11"];$_SESSION['dh11']=$_REQUEST['dh11']; $dh11=$_SESSION["dh11"];$_SESSION['ndh11']=$_REQUEST['ndh11']; $ndh11=$_SESSION["ndh11"];}
else{$_SESSION['h11']=0;$_SESSION['dh11']=0;$_SESSION['ndh11']=0;}
if ($_POST["h12"]){$_SESSION['h12']=$_REQUEST['h12']; $h12=$_SESSION["h12"];$_SESSION['dh12']=$_REQUEST['dh12']; $dh12=$_SESSION["dh12"];$_SESSION['ndh12']=$_REQUEST['ndh12']; $ndh12=$_SESSION["ndh12"];}
else{$_SESSION['h12']=0;$_SESSION['dh12']=0;$_SESSION['ndh12']=0;}
...
$sqlUpdate = mysql_query("UPDATE metas SET enero=$ting1,dh1=$dh1,ndh1=$ndh1,horas1=$h1,
								 ...
								 total_gastop=$gtot,estrategia='$estrategias'
							  	 WHERE clave='$clave' and id_emp=$id_emp", $connect) or die(mysql_error());

						if($sqlUpdate){echo "<span class=\"spblue\">La meta se ha editado correctamente!!!</span>";}
						else{echo "<span class=\"spred\">Error en el registro de la meta!!!</span>";}
echo "		<br>";
echo "<input type=\"button\" value=\"atras\" onclick=\"history.go(-1)\" /> | <input type=\"submit\" value=\"Regresar\" />";

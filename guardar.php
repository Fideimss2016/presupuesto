...
/*
	...
	echo 	"Año: ".$anio;
		...
		{
			$id 				= $data['id'];
			$insArchivo = mysql_query("insert into archivos (id_conse_obra, ruta, nombre_archivo, nombre_original, tipo_archivo, extension, usuario) values 
			($id, 'archivos/', '', '', '', '', '$usuario')", $connect);
		}
*/

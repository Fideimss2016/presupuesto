...
$aux=$aux."<th bgcolor=\"#efefef\" scope=\"col\"><span class=\"titulo_small\">Concepto</span></th>";
...
$aux=$aux."  </tr>";
			...
			$result=mysql_query("select o.monto as monto0401, o.origen_del_gasto, o.cantidad, o.unidad
								 from obras o
...
$aux=$aux."  </tr>";
			...
			$result=mysql_query("select o.monto as monto0402, o.origen_del_gasto, o.cantidad, o.unidad
								 from obras o
...
$aux=$aux."  </tr>";
			...
			$result=mysql_query("select o.monto as monto0501, o.origen_del_gasto, o.cantidad, o.unidad
								 from obras o
...
$aux=$aux."  </tr>";
			...
			$result=mysql_query("select o.monto as monto0502, o.origen_del_gasto, o.cantidad, o.unidad
								 from obras o
...
//echo "    <td align=\"center\" bgcolor=$color valign=\"top\"><span class=\"spgreen\"> " . number_format($montot,2) . "</span></td>";

...
echo "    <h3>Captura Presupuesto 2016</h3>";

echo "		<p class=\"spwhite\">";
echo "		<b>Resumen de Capturas en el Sistema de Presupuesto 2016</b>";
echo "		</p>";
...
echo "<tr><th scope=\"col\" bgcolor=\"$c1\" colspan=\"3\" align=\"left\"><span class=\"spgrey\">&nbsp;<b>$desc_del</b></th></tr>";
	...
	echo "<tr>
	      <td bgcolor=\"$celda\" align=\"left\"><span class=\"$color\">$clave $desc_uops </span><a href=\"vcapturaso.php?clave=$clave\" class=\"grey\" target=\"_blank\">ver detalle</a> |
		  <a href=\"ver_detalle_obra.php?clave=$clave\" class=\"grey\" target=\"_blank\">ver capturas</a> | </td>

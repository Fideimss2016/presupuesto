...
echo "    <h2>Edicion de Plan de Trabajo</h2>";

echo "		<p class=\"spwhite\">";
echo "		<b></b>Usted esta editando plan de trabajo";
echo "		</p>";

echo "		<div id=\"cajaareas\">";
echo "		<form action=\"inserta_edita_plan.php\" method=\"post\" enctype=\"multipart/form-data\" target=\"_self\" name=\"a\">";
...
echo "<br \>";
			...
			$result=mysql_query("select tema,objpar,tecnica,material,docente,usuario,sesiones,horasxsesion
								 from plan
								 where clave='$clave' and id_emp=$id_emp and conse_plan=$conse_plan", $connect);
...
echo "		<tr>";
echo "		<td bgcolor=\"$celda\" align=\"right\" valign=\"top\"><label for=\"tema\" class=\"spgrey\">Tema:</label></td><td colspan=\"3\" bgcolor=\"$celda\"><textarea rows=\"3\" cols=\"80\" name=\"tema\">
$tema
</textarea>";
echo "		</td></tr>";
...
echo "		<tr>";
echo "		<td bgcolor=\"$celda\" align=\"right\" valign=\"top\"><label for=\"tecnica\" class=\"spgrey\"><b>Tecnica:</b></label></td><td colspan=\"3\" bgcolor=\"$celda\"><textarea rows=\"3\" cols=\"80\" name=\"tecnica\">
$tecnica
</textarea>";
echo "		</td></tr>";
...
echo "		</td>";
echo "		<td bgcolor=\"$celda\" colspan=\"1\">";
echo "		<input type=\"number\" name=\"sesiones\" id=\"sesion\" size=\"10\" required $vale value=\"$sesiones\">";
echo "		</td>";
...
echo "		</td>";
echo "		<td bgcolor=\"$celda\" colspan=\"3\">";
echo "		<span class=\"spblue\"><input type=\"number\" id=\"horasxsesion\" name=\"horasxsesion\" required $vale value=\"$horasxsesion\"></span>";
echo "		</td>";
echo "		</tr>";
...
echo "<br \>";
echo "<input type=\"button\" value=\"atras\" onclick=\"history.go(-1)\" /> | <input type=\"submit\" value=\"Editar Plan\" />";

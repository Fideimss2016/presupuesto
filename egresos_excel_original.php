<?php
	...
	$aux = "<center><h4><font color=\"#000\">Presupuesto De Egresos Ejercicio 2016</font></h4></center>";
	...
	*/
	$resulto = mysql_query("select o.id_conse_obra, o.clave_act, o.clave_par, o.cantidad, o.unidad, o.monto as total_gastoo, a.actividad, p.desc_par, o.status, o.origen_del_gasto, o.enero, o.febrero, o.marzo, 
		...
		left join cat_actividades_i a on a.clave_act = o.clave_act left join cat_delegaciones d on d.clave = o.clave where o.clave = '$clave' order by o.clave_par", $connect);

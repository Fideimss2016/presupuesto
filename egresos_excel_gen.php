...
$aux=$aux."  <tr>";
$aux=$aux."    <th bgcolor=$celda scope=\"col\"><span class=\"titulo_small\">Delegacion</span></th>";
$aux=$aux."    <th bgcolor=$celda scope=\"col\"><span class=\"titulo_small\">UOPSI</span></th>";
$aux=$aux."    <th bgcolor=$celda scope=\"col\"><span class=\"titulo_small\">Partida</span></th>";
$aux=$aux."    <th bgcolor=$celda scope=\"col\"><span class=\"titulo_small\">Categoria / Gasto</span></th>";
...
/*personal*/
			/*
			echo "select p.id_conse_personal,p.clave_act,p.clave_par,p.cantidad,ci.actividad,cp.desc_par,
			p.conse_categoria,
			p.ene,p.feb,p.mar,p.abr,p.may,p.jun,p.jul,p.ago,p.sep,p.oct,p.nov,p.dic,cc.desc_categoria,cc.subtotal,p.status,p.meses,cd.desc_uops, cd.desc_del,p.gas_anual,p.cvr
			from personal p, cat_actividades_i ci, cat_partidas_e cp, cat_categoria cc, cat_delegaciones cd
			where cd.clave=p.clave and ci.clave_act=p.clave_act and cp.clave_par=p.clave_par and cc.conse_categoria=p.conse_categoria order by clave_par, id_conse_personal";

			echo "select e.id_conse_egresos,e.clave_act,e.clave_par,e.cantidad,ci.actividad,cp.desc_par,
			e.unidad,e.total_gasto,ci.actividad,cp.desc_par,
			...
			where cd.clave=e.clave and ci.clave_act=e.clave_act and cp.clave_par=e.clave_par order by clave_par";

			echo "select o.id_conse_obra,o.clave_act,o.clave_par,o.cantidad,o.unidad,o.total_gastoo,ci.actividad,cp.desc_par,
			...
			where cd.clave=o.clave and ci.clave_act=o.clave_act and cp.clave_par=o.clave_par order by clave_par";	
			*/
			...
			from personal p, cat_actividades_i ci, cat_partidas_e cp, cat_categoria cc, cat_delegaciones cd
			where cd.clave=p.clave and ci.clave_act=p.clave_act and cp.clave_par=p.clave_par and cc.conse_categoria=p.conse_categoria order by clave_par, id_conse_personal", $connect);
...
/*egresos*/
			...
			e.origen_del_gasto,e.enero,e.febrero,e.marzo,e.abril,e.mayo,e.junio,e.julio,e.agosto,e.septiembre,e.octubre,e.noviembre,e.diciembre,cd.desc_uops, cd.desc_del
			from egresos e, cat_actividades_i ci, cat_partidas_e cp, cat_delegaciones cd
			where cd.clave=e.clave and ci.clave_act=e.clave_act and cp.clave_par=e.clave_par order by clave_par", $connect);
...
/*obras*/
			...
			o.origen_del_gasto,o.enero,o.febrero,o.marzo,o.abril,o.mayo,o.junio,o.julio,o.agosto,o.septiembre,o.octubre,o.noviembre,o.diciembre,cd.desc_uops, cd.desc_del
			from obras o, cat_actividades_i ci, cat_partidas_e cp, cat_delegaciones cd 
			where cd.clave=o.clave and ci.clave_act=o.clave_act and cp.clave_par=o.clave_par order by clave_par", $connect);

...
if($tip!=-1)
{
echo "		<form action=\"personal_1.php\" method=\"post\" enctype=\"multipart/form-data\" target=\"_self\" name=\"a\">";
...
echo "		<select name=\"conse_act\">";
			$result=mysql_query("select conse_act, clave_act, actividad from cat_actividades_i where clave_act!=0 order by conse_act", $connect);
...
{
echo "		<select name=\"conse_act\">";
			$result=mysql_query("select conse_act, clave_act, actividad from cat_actividades_i where clave_act=47119", $connect);
...
echo "		</tr>";
	...
	{
	echo "<tr><td  colspan=\"4\" align=\"center\"><span class=\"spred\">El Plan Rector 2016 correspondiente al Area de Personal ya se ha enviado a revisi&oacute;n ya no es posible realizar capturas!!!</span></td></tr>";
	}

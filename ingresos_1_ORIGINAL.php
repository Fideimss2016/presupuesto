...
echo "		</tr>";
			...
			echo "		</tr>";
				...
				echo "		</td>";
				echo "		<td bgcolor=\"$celda\">";
				echo "		<span class=\"spblue\"><input type=\"text\" id=\"popupDatepicker\" name=\"inicio\" value=\"01-01-2015\"></span>";
				echo "		</td>";
				...
				echo "		</td>";
				echo "		<td bgcolor=\"$celda\">";
				echo "		<span class=\"spblue\"><input type=\"text\" id=\"popupDatepickers\" name=\"termino\" value=\"31-12-2015\"></span>";
				echo "		</td>";
				echo "		</tr>";
				}
				else

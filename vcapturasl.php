...
$colorfila=0;
			...
			ctc.id_tipo_curso=i.id_tipo_curso", $connect);
...
/***FORMULARIO RESPUESTA***/
	...
	//se recogen las consultas en un array y se muestran
		...
		$desc_del=$row['desc_del'];
									...
									$sqlUpdate = mysql_query("UPDATE vobo SET jefe_i=1,fec_jefe_i='$hoy' where clave='$clave'", $connect) or die(mysql_error());
...
<p>
<b>C.P. Reynaldo Arias Villavicencio</b><br><br> Le informo que el usuario ". $jefe ." Jefe de Ofcina de Deporte de la Delegacion $desc_del ha aprobado el Plan Rector 2017 correspondiente al Area de Ingresos de $desc_uops por lo que a enviado solicitud de autorizacion del mismo.<br><br><b>Este es un mensaje del sistema</b>
</p>
</body>
</html>
";
...
$headers .= "Cc: fideimss@fideimss.org.mx, kenia.jaramillo@fideimss.org.mx\r\n";
...
if($result!=0)
{
	...
	else if($status==1 && $numerosc!=0)
	{
									...
									$sqlUpdate = mysql_query("UPDATE ingresos SET status=0 where clave='$clave'", $connect) or die(mysql_error());
									if($sqlUpdate)
									{
									echo "El Plan Rector 2017 correspondiente al &Aacute;rea de Ingresos se ha liberado!!!";
									$sqlUpdate = mysql_query("UPDATE vobo SET jefe_i=0 where clave='$clave'", $connect) or die(mysql_error());
									
									}
									else
									{
									echo "El Plan Rector 2017 correspondiente al &Aacute;rea de Ingresos no ha sido liberado!!!";										
									}

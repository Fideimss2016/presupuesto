<?php
	...
	if(isset($_REQUEST['conse_acts'])){$_SESSION['conse_acts'] = $_REQUEST['conse_acts'];}
	if(isset($_REQUEST['id_tipo_curso'])){$_SESSION['id_tipo_curso'] = $_REQUEST['id_tipo_curso'];}
	if(isset($_REQUEST['id_tipo_pago'])){$_SESSION['id_tipo_pago'] = $_REQUEST['id_tipo_pago'];}
	if(isset($_SESSION['conse_acts'])){$conse_acts = $_SESSION["conse_acts"];}
	if(isset($_SESSION['id_tipo'])){$id_tipo_curso = $_SESSION["id_tipo_curso"];}
	...
	//if($conse_acts == 64)
	if($conse_acts == 64)//Uso de instalaciones
	{
		echo "		<tr>";
		echo "		<td bgcolor=\"$celda\" align=\"right\">";
	...
	else if ($conse_acts == 47 || $conse_acts == 48 || $conse_acts == 49 || $conse_acts == 50 || $conse_acts == 51 || $conse_acts == 63 || $conse_acts == 99)
	{
		echo "		<tr><td bgcolor=\"$celda\" colspan=\"4\"><br><p class=\"spwhite\" align=\"center\"><b>Para Ligas Deportivas y Torneo de Invitacion marque del 01 de enero al 31 de diciembre</b></p></td></tr>";
	}
	else
	{
		echo "		<tr>";
	...
	if($conse_acts == 1 || $conse_acts == 2 || $conse_acts == 3 || $conse_acts == 4 || $conse_acts == 5 || $conse_acts == 6 || $conse_acts == 7 || $conse_acts == 8 || $conse_acts == 9 || $conse_acts == 10 || $conse_acts == 11 || $conse_acts == 12 || $conse_acts == 13 || $conse_acts == 14 || $conse_acts == 15 || $conse_acts == 16 || $conse_acts == 17 || $conse_acts == 18 || $conse_acts == 19 || $conse_acts == 20 || $conse_acts == 21 || $conse_acts == 22 || $conse_acts == 23 || $conse_acts == 24 || $conse_acts == 25 || $conse_acts == 26 || $conse_acts == 27 || $conse_acts == 28 || $conse_acts == 29 || $conse_acts == 30 || $conse_acts == 31 || $conse_acts == 32 || $conse_acts == 33 || $conse_acts == 34 || $conse_acts == 35 || $conse_acts == 36 || $conse_acts == 37 || $conse_acts == 38 || $conse_acts == 39 || $conse_acts == 40 || $conse_acts == 41 || $conse_acts == 42 || $conse_acts == 43 || $conse_acts == 44 || $conse_acts == 45 || $conse_acts == 46 || $conse_acts == 52 || $conse_acts == 53 || $conse_acts == 54 || $conse_acts == 55 || $conse_acts == 56 || $conse_acts == 57 || $conse_acts == 58 || $conse_acts == 59 || $conse_acts == 60 || $conse_acts == 61 || $conse_acts == 62 || $conse_acts == 65 || $conse_acts == 66 || $conse_acts == 67 || $conse_acts == 68 || $conse_acts == 69 || $conse_acts == 70)
	{
		echo "		<tr>";
		echo "		<td bgcolor=\"$celda\" align=\"right\">";

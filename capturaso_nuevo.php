<?php
	...
	echo "<center><h1><font color=\"#000\">Detalle de proyectos registrados en sistema $desc_uops</font></h1></center>";
	...
	//echo "    <th bgcolor = $celda scope=\"col\"><span class=\"titulo_small\">Descripci&oacute;n del concepto</span></th>";
	echo "    <th bgcolor = $celda scope=\"col\"><span class=\"titulo_small\">Beneficios esperados</span></th>";
	echo "    <th bgcolor = $celda scope=\"col\"><span class=\"titulo_small\">Recuperacion de la inversion</span></th>";
	echo "    <th bgcolor = $celda scope=\"col\"><span class=\"titulo_small\">Tipo de Gasto</span></th>";
	echo "  </tr>";
	...
	*/
/*	
	$result = mysql_query("select o.id_conse_obra, o.monto, o.clave_par, o.observaciones as desc_proyecto, p.desc_par, b.beneficio as beneficios, o.status, o.c1, o.c2, o.c3, o.c4, o.c5, o.c6, o.periodo, 
		g.tipo_gasto from obras o, cat_partidas_e p, cat_beneficios b, cat_tipo_gasto g	where o.clave = '$clave' and p.conse_partidas = o.tipo_proyecto_id and b.beneficio_id = o.beneficio_id 
		and g.tipo_gasto_id = o.tipo_gasto_id and o.activo = 1", $connect);
*/
/*
	$result = mysql_query("select o.id_conse_obra, o.monto, o.clave_par, o.observaciones as desc_proyecto, p.desc_par, b.beneficio as beneficios, o.status, o.c1, o.c2, o.c3, o.c4, o.c5, o.c6, o.periodo, 
		g.tipo_gasto from obras o, cat_partidas_e p, cat_beneficios b, cat_tipo_gasto g where o.activo = 1 and o.clave = '$clave' and p.conse_partidas = o.tipo_proyecto_id and b.beneficio_id = o.beneficio_id 
		and g.tipo_gasto_id = o.tipo_gasto_id and o.activo = 1", $connect);
*/

	$result = mysql_query("select o.id_conse_obra, o.monto, o.clave_par, o.observaciones as desc_proyecto, p.desc_par, b.beneficio as beneficios, o.status, o.c1, o.c2, o.c3, o.c4, o.c5, o.c6, o.periodo, 
		g.tipo_gasto from obras o left join cat_partidas_e p on p.conse_partidas = o.tipo_proyecto_id left join cat_beneficios b on b.beneficio_id = o.beneficio_id left join cat_tipo_gasto g 
		on g.tipo_gasto_id = o.tipo_gasto_id where o.activo = 1 and o.clave = '$clave'", $connect);


		 /* union select o.id_conse_egresos, o.total_gasto as monto, o.clave_par, o.observaciones as desc_proyecto, p.desc_par, ' ' as beneficios, 
		o.status, 0 as 'c1', 0 as 'c2', 0 as 'c3', 0 as 'c4', 0 as 'c5', 0 as 'c6', ' ' as periodo, ' ' as 'tipo_gasto' from egresos o, cat_partidas_e p where o.clave = '$clave' 
		and p.clave_par = o.clave_par", $connect); */
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$desc_proyecto = htmlentities($row['desc_proyecto']);
		$desc_par = htmlentities($row['desc_par']);
		//$problematica = $row['problematica'];
		//$objetivo = $row['objetivo'];
		$beneficios = htmlentities($row['beneficios']);
		$status = $row['status'];
		$c1 = $row['c1'];
		$c2 = $row['c2'];
		$c3 = $row['c3'];
		...
		echo "	  <td align=\"left\" bgcolor = $color valign=\"top\"><span class=\"spgreen\">$periodo</span></td>";
		...
		if($c6 != 0)
		{
			...
			echo "<input type=\"checkbox\" checked disabled><span class=\"spgreen\">Otros </span>&nbsp;&nbsp;&nbsp;<span class=\"spgrey\"></span>";
		}
*/
		echo "	  </span></td>";
		echo "  </tr>";

...
if($jefe_i==1 && $jefe_o==1 && $jefe_e==1 && $jefe_p==1)
{
	...
	// Cabecera de página
		function Header()
		{
			...
			$this->MultiCell(354,4,'PRESUPUESTO DE EGRESOS EJERCICIO 2015',0,'C');
			// Salto de línea
			$this->Ln(20);
...
$pdf->Cell(63,6,"",1,'L',1);
$pdf->SetXY(5,$y);
$pdf->MultiCell(63,4,$clave_par . ' ' .$desc_par,0,'L',0);

$pdf->SetXY(68,$y);
$pdf->Cell(48,6,"",1,'L',1);
$pdf->SetXY(68,$y);
$pdf->MultiCell(48,4,$desc_categoria,0,'L',0);

$pdf->SetXY(116,$y);
$pdf->Cell(37,6,"",1,'L',1);
$pdf->SetXY(116,$y);
$pdf->MultiCell(37,4,$clave_act . ' ' .$actividad,0,'L',0);
...
$pdf->Cell(48,6,"",1,'L',1);
$pdf->SetXY(68,$y);
$pdf->MultiCell(48,4,$origen_del_gasto,0,'L',0);
...
$colorfila=0;
			...
			e.origen_del_gasto,e.enero,e.febrero,e.marzo,e.abril,e.mayo,e.junio,e.julio,e.agosto,e.septiembre,e.octubre,e.noviembre,e.diciembre
			from egresos e, cat_actividades_i ci, cat_partidas_e cp 
			where clave=$clave and ci.clave_act=e.clave_act and cp.clave_par=e.clave_par and e.id_par in ('03')  order by clave_par", $connect);
...
$y=$y+10;
$pdf->SetXY(5,$y);
$pdf->MultiCell(285,4,".: CONSERVACION :.",0,'L');
...
$y=$y+4;
			...
			$result=mysql_query("select o.id_conse_obra,o.clave_act,o.clave_par,o.cantidad,o.unidad,o.total_gastoo,ci.actividad,cp.desc_par,
			...
			where clave=$clave and o.clave_par in ('0401','0402') and ci.clave_act=o.clave_act and cp.clave_par=o.clave_par order by o.clave_par", $connect);
...
$y=$y+4;
			...
			o.origen_del_gasto,o.enero,o.febrero,o.marzo,o.abril,o.mayo,o.junio,o.julio,o.agosto,o.septiembre,o.octubre,o.noviembre,o.diciembre
			from obras o, cat_actividades_i ci, cat_partidas_e cp 
			where clave=$clave and o.clave_par in ('0501','0502') and ci.clave_act=o.clave_act and cp.clave_par=o.clave_par order by o.clave_par", $connect);
...
$pdf->Cell(83,4,"",1,'L',1);
$pdf->SetXY(5,$y1);
$pdf->MultiCell(83,4,"4. CONSERVACION",0,'L',0);
$pdf->SetXY(88,$y);
$pdf->Cell(40,4,"",1,'L',1);
$pdf->SetXY(88,$y1);
...
$ggtotal=$gingretot+$gingretot1+$gingretot_1+$gingretot_2+$gingretot_3+$gingretot_5+$gingretotp_1;

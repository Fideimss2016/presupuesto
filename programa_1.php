...
echo "		<b>Paso 2</b> Verificar que la informaci&oacute;n programada sea correcta";
echo "		</p>";

echo "		<div id=\"cajaareas\">";
echo "		<form action=\"inserta_programa.php\" method=\"post\" enctype=\"multipart/form-data\" target=\"_self\" name=\"a\">";

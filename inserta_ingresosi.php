...
//	include "valida_seguridad.php";
	...
	*/
	...
	if($resultado)
	{
		echo "<span class=\"spblue\">La actividad se ha registrado satisfactoriamente!!!</span>";
	}
	else
	{
		echo "<span class=\"spred\">Error en el registro de la actividad!!!</span>";
	}
	echo "<br \>";

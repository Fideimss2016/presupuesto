					...
					<fieldset>
						...
						<table>
							...
							<tr>
								...
								<td>
									<select name="beneficio_id" id="beneficio_id" onchange="javascript:OcultarTextBox(this);">
										<option value='1' selected>Atención a quejas de usuarios</option>
										<option value='2'>Atención de observaciones</option>
										<option value='3'>Incremento de ingresos</option>
										<option value='4' selected>Mejora de imagen</option>

...
(function($) { // Hide scope, no $ conflict
    ...
    function Datepicker() {
        this._defaults = {
            ...
            yearRange: '2016:2017', // Range of years to show in drop-down: 'any' for direct text entry
        ...
        this.regional[''] = { // US/English
            ...
            prevStatus: 'Mes anterior', // Status text for the previous month command
            prevJumpText: '&lt;&lt;', // Text for the previous year command
            prevJumpStatus: 'Año anterior', // Status text for the previous year command
            nextText: 'Sig.&gt;', // Text for the next month command
            nextStatus: 'Mes sig.', // Status text for the next month command
            nextJumpText: '&gt;&gt;', // Text for the next year command
            nextJumpStatus: 'Año siguiente', // Status text for the next year command
            currentText: 'Actual', // Text for the current month command
            currentStatus: 'Mes actual', // Status text for the current month command
            todayText: 'Hoy', // Text for the today's month command
            todayStatus: 'Mes actual', // Status text for the today's month command
            clearText: 'Borrar', // Text for the clear command
            clearStatus: 'Borrar fecha', // Status text for the clear command
            closeText: 'Cerrar', // Text for the close command
            closeStatus: 'Cierra calendario', // Status text for the close command
            yearStatus: 'Cambiar año', // Status text for year selection
            monthStatus: 'Cambiar mes', // Status text for month selection
            weekText: 'Sem', // Text for week of the year column header
            ...
            defaultStatus: 'Selecciona una fecha', // Status text shown by default
    ...
    $.extend(Datepicker.prototype, {
        ...
        _attachments: function(target, inst) {
            ...
            inst.trigger = (!trigger ? $([]) :
                $(trigger).clone().removeAttr('id').addClass(this._triggerClass)[inst.options.isRTL ? 'insertBefore' : 'insertAfter'](target).click(function() {
